...
This markdown file contains a detailed exploratory analysis of green building to analyse if a green building is financially more feasible than a non-green building
```{r, include=FALSE}
library(dplyr)
library(ggplot2)
library(xtable)
